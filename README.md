...
- what about Navbar?
- decide on root (parent route) -- then move others to children
- make path relative -- import Outlet
...
#### Dashboard Context
- When it comes to the outlet. So basically to our pages,React Router has a built in prop - context which works as a context.

- set up context
- useDashboardContext : custom hook
...
- refresh - back to not darktheme
- localstorage - And remember, we're saving this as a string, not as a Boolean.
